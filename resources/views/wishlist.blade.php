                    ...
                    <tr>
                        ...
                        <td>
                          <div class="row">
                            ...
                            <div class="col-6">
                              <form method="POST" action="{{ route('wishlist.removeItem', ['rowId' => $item->rowId]) }}" id="item-remove-{{ $item->id }}">
                                @csrf
                                @method('DELETE')
                                <a href="javascript:void(0);" class="remove-cart" onclick='document.getElementById("item-remove-{{ $item->id }}").submit();'>
