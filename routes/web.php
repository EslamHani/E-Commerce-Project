...
Route::get('shop/{slug}', [ShopController::class, 'details'])->name('shop.product.details');
Route::get('cart', [CartController::class, 'index'])->name('cart.index');
Route::post('cart/add', [CartController::class, 'add_to_cart'])->name('cart.add');
Route::put('cart/increase-quantity/{rowId}', [CartController::class, 'increase_cart_quantity'])->name('cart.qtyIncrease');
Route::put('cart/decrease-quantity/{rowId}', [CartController::class, 'decrease_cart_quantity'])->name('cart.qtyDecrease');
Route::delete('cart/remove/{rowId}', [CartController::class, 'remove_item'])->name('cart.removeItem');
Route::delete('cart/emptycart', [CartController::class, 'empty_cart'])->name('cart.emptyCart');
...
Route::delete('wishlist/remove/{rowId}', [WishlistController::class, 'remove_item'])->name('wishlist.removeItem');
Route::delete('wishlist/emptywishlist', [WishlistController::class, 'empty_wishlist'])->name('wishlist.emptywishlist');
